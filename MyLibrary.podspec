...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = 'happy test hahahahaha'

  s.homepage         = 'https://github.com/lijie28/testPod.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lijie9228@hotmail.com' => 'lijie9228@hotmail.com' }
  s.source           = { :git => 'https://github.com/lijie28/testPod.git', :tag => s.version.to_s }
